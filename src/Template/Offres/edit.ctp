...
<div class="wrapper">
    ...
    <div id="page-content">
        ...
        <div class="container">
            ...
            <?= $this->Form->create(null, ['url' => ['action' => 'edit'], 'enctype' => 'multipart/form-data']); ?>
                <div class="row">
                    <div class="block">
                        <div class="col-md-12 col-sm-12">
                            <section id="submit-form">
                                <section id="basic-information">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <?= $this->Form->input('type_ad_id', ['options' => $ads , 'label' => 'Type de bien', 'selected' => $offers->type_id]); ?>
                                            </div><!-- /.form-group -->
                                        </div>
                                        <div class="col-md-3">
                                            <label for="submit-location">Type d'offre</label>
                                            <div class="form-group">
                                                <select name="select">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <?= $this->Form->input('price',['label' => 'Prix', 'value' => $offers->price]); ?>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <?= $this->Form->input('city',['label' => 'Ville', 'value'=>$offers->town->town_name]); ?>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <?= $this->Form->input('surface',['label' => 'Surface', 'value'=> $offers->surface]); ?>
                                    ...
                                    <div class="form-group">
                                    <?= $this->Form->input('textarea',['label' => 'description', 'value'=> $offers->description, 'rows'=>8]); ?>
                                    </div><!-- /.form-group -->
